...
def test_selenium(self):
    ...
    sleep(3)
    # 填写姓名
    self.driver.find_element_by_xpath('//*[@id="username"]').send_keys('小韩2')
    logging.info('成功填写姓名')
    sleep(1)
    # 填写别名
    self.driver.find_element_by_xpath('//*[@id="memberAdd_english_name"]').click()
    self.driver.find_element_by_xpath('//*[@id="memberAdd_english_name"]').send_keys('小小韩2')
    sleep(1)
    logging.info('成功填写别名')
    # 填写账号
    self.driver.find_element_by_xpath('//*[@id="memberAdd_acctid"]').click()
    self.driver.find_element_by_xpath('//*[@id="memberAdd_acctid"]').send_keys('775773')
    sleep(1)
    logging.info('成功填写账号')
    # 填写手机号
    self.driver.find_element_by_xpath('//*[@id="memberAdd_phone"]').click()
    self.driver.find_element_by_xpath('//*[@id="memberAdd_phone"]').send_keys('18733506886')
    sleep(1)
    logging.info('成功填写手机号')
    # 其余非必填项未填，点击保存按钮，完成新增
    self.driver.find_element_by_link_text('保存').click()
    logging.info('完成新增')
    a = self.driver.find_element_by_xpath('//*[@id="member_list"]/tr[2]/td[2]/span').text
    assert a == '小韩2'
